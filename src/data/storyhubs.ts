...
export const storyHubs: StoryHub[] = [
  ...
  },
  {
    ...
    blurb:
      'Railroads, oil, steel, the Chinese Exclusion Act, and the Model T. Five sources on the fortunes built between 1862 and 1914 and the people whose labor and lives paid for them.',
    ...
    topics: ['gilded age', 'railroads', 'standard oil', 'carnegie steel', 'chinese exclusion', 'model t'],
    inside: [
      'Five source sections covering the railroad, oil, steel, the law of 1882, and the car.',
      'Interactive refinery, supply chain, and Model T price tools that show how the fortunes were built.',

...
try {
  ...
  const stages = ['hall-pass:verify', 'tools:test', 'classroom:test', 'resources:validate', 'storyhub:validate', 'check', 'build', 'site:validate'];
  ...
  console.log(`Public-resource and release-gate fixtures: ${passed} passed. Success/failure inputs unchanged; all eight stages stop on failure.`);
} finally {
